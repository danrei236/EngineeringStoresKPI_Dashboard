...
WARNING:
    Running this script will drop the entire 'DataWarehouseRetail' database if it exists. 
...
-- Drop and recreate the 'DataWarehouseRetail' database
...
-- Create the 'DataWarehouseRetail' database
